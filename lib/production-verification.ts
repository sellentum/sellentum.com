...
function buildDesktopQa({
  ...
  return [
    ...
    },
    {
      ...
      route: `/finder/${publishedFinder?.slug || publishedFinder?.id || "[finder-id]"}`,
    ...
    },
    {
      ...
      status: publishedFinder?.published ? "pass" : "warn",
      route: `/assistant/${publishedFinder?.slug || publishedFinder?.id || "[finder-id]"}`,
    ...
    },
    {
      ...
      status: publishedFinder?.published ? "pass" : "warn",
      route: `/search/${publishedFinder?.slug || publishedFinder?.id || "[finder-id]"}`,
    ...
    },
    {
      ...
      route: `/configurator/${publishedConfigurator?.slug || publishedConfigurator?.id || "[configurator-id]"}`,
