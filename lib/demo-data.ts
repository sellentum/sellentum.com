...
export const demoEvents: AnalyticsEvent[] = [
  ...
  {
    id: "event_feedback_trail_positive",
    user_id: DEMO_USER_ID,
    quiz_id: demoQuiz.id,
    product_id: "prod_trail",
    ...
    metadata: {
      ...
      experience_id: demoQuiz.id,
      experience_name: demoQuiz.name,
      session_id: "demo_session_0",
      ...demoAttribution(88),
      feedback: "positive",
      feedback_reason: "helpful_match",
      feedback_surface: "finder_result_card",
      rank: 1,
      score: 8,
      product_name: "Terra Trail Runner",
      matched_reasons: ["Trails & outdoors", "Soft cushioning"],
      explanation_present: true,
    },
    created_at: new Date().toISOString(),
  },
  {
    id: "event_feedback_cloud_negative",
    user_id: DEMO_USER_ID,
    quiz_id: demoQuiz.id,
    product_id: "prod_cloud",
    event_type: "recommendation_feedback",
    metadata: {
      ...
      ...demoAttribution(89),
      feedback: "negative",
      feedback_reason: "weak_explanation",
      feedback_surface: "finder_result_card",
      rank: 2,
      score: 5,
      product_name: "Cloud Rest Walker",
      matched_reasons: ["Soft cushioning"],
      explanation_present: true,
    },
    created_at: new Date().toISOString(),
  },
  {
    id: "event_feedback_speed_negative",
    user_id: DEMO_USER_ID,
    quiz_id: demoQuiz.id,
    product_id: "prod_speed",
    event_type: "recommendation_feedback",
    metadata: {
      experience_type: "assistant",
      experience_id: demoQuiz.id,
      experience_name: demoQuiz.name,
      session_id: "demo_session_5",
      ...demoAttribution(90),
      query: "responsive road running under 120",
      terms: ["responsive", "road", "running"],
      feedback: "negative",
      feedback_reason: "too_expensive",
      feedback_surface: "advisor_result_card",
      rank: 1,
      score: 6,
      product_name: "Velocity Road Pro",
      explanation_present: true,
    },
    created_at: new Date().toISOString(),
  },
  {
    id: "event_feedback_trail_search_positive",
    user_id: DEMO_USER_ID,
    quiz_id: demoQuiz.id,
    product_id: "prod_trail",
    event_type: "recommendation_feedback",
    metadata: {
      ...
      terms: ["waterproof", "trail"],
      feedback: "positive",
      feedback_reason: "clear_explanation",
      feedback_surface: "search_result_card",
      rank: 1,
      score: 9,
      product_name: "Terra Trail Runner",
      explanation_present: true,
