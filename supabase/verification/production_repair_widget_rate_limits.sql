...
-- 2. public.rate_limit_buckets does not exist
--
-- This file is intentionally idempotent. It is safe to run more than once in
-- the production Supabase SQL editor.

begin;

-- 008_widget_allowed_domains.sql
alter table public.widget_settings
add column if not exists allowed_domains text[] not null default '{}';

-- 009_shared_rate_limits.sql
...
-- Ask PostgREST/Supabase API to refresh schema metadata quickly.
