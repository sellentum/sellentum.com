...
import { BarChart3, BookOpenCheck, Boxes, ChevronDown, ClipboardCheck, ExternalLink, FlaskConical, HelpCircle, LayoutDashboard, LogOut, Menu, PackagePlus, Rocket, Search, Settings, Sparkles, X } from "lucide-react";
