...
import { AlertTriangle, Archive, ArrowDownRight, ArrowRight, ArrowUpRight, BookOpenCheck, Bot, Boxes, Braces, BrainCircuit, Check, ChevronRight, CirclePlay, ClipboardCheck, Code2, CreditCard, Database, Eye, FileText, GalleryVerticalEnd, GitBranch, GitPullRequestArrow, Globe2, Handshake, HeartPulse, Layers3, LayoutTemplate, Megaphone, MessageCircle, MonitorCheck, MousePointerClick, Network, PackagePlus, RadioTower, Rocket, Search, ShieldCheck, SlidersHorizontal, Sparkles, Target, ThumbsUp, UsersRound, Wrench } from "lucide-react";
    ...
    <div className="animate-rise">
      <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
        ...
        <div className="flex flex-wrap justify-end gap-3">
          ...
          <Link href="/dashboard/data-contract" className="inline-flex items-center gap-2 rounded-full border border-black/10 bg-white px-5 py-3 text-xs font-extrabold text-ink shadow-sm transition hover:-translate-y-0.5"><Database size={15} className="text-moss" /> Data Contract</Link>
          <Link href="/dashboard/ai-readiness" className="inline-flex items-center gap-2 rounded-full border border-black/10 bg-white px-5 py-3 text-xs font-extrabold text-ink shadow-sm transition hover:-translate-y-0.5"><Sparkles size={15} className="text-moss" /> AI Readiness</Link>
          ...
          <Link href="/dashboard/feedback" className="inline-flex items-center gap-2 rounded-full border border-black/10 bg-white px-5 py-3 text-xs font-extrabold text-ink shadow-sm transition hover:-translate-y-0.5"><ThumbsUp size={15} className="text-moss" /> Feedback</Link>
          <Link href="/dashboard/content" className="inline-flex items-center gap-2 rounded-full border border-black/10 bg-white px-5 py-3 text-xs font-extrabold text-ink shadow-sm transition hover:-translate-y-0.5"><FileText size={15} className="text-moss" /> Content Studio</Link>
          <Link href="/dashboard/merchandising" className="inline-flex items-center gap-2 rounded-full border border-black/10 bg-white px-5 py-3 text-xs font-extrabold text-ink shadow-sm transition hover:-translate-y-0.5"><SlidersHorizontal size={15} className="text-moss" /> Merchandising</Link>
          <Link href="/dashboard/compatibility" className="inline-flex items-center gap-2 rounded-full border border-black/10 bg-white px-5 py-3 text-xs font-extrabold text-ink shadow-sm transition hover:-translate-y-0.5"><Network size={15} className="text-moss" /> Compatibility</Link>
          <Link href="/dashboard/bundles" className="inline-flex items-center gap-2 rounded-full border border-black/10 bg-white px-5 py-3 text-xs font-extrabold text-ink shadow-sm transition hover:-translate-y-0.5"><PackagePlus size={15} className="text-moss" /> Bundle Studio</Link>
          <Link href="/dashboard/returns" className="inline-flex items-center gap-2 rounded-full border border-black/10 bg-white px-5 py-3 text-xs font-extrabold text-ink shadow-sm transition hover:-translate-y-0.5"><HeartPulse size={15} className="text-moss" /> Returns & fit</Link>
          ...
          <Link href="/dashboard/audience" className="inline-flex items-center gap-2 rounded-full border border-black/10 bg-white px-5 py-3 text-xs font-extrabold text-ink shadow-sm transition hover:-translate-y-0.5"><UsersRound size={15} className="text-moss" /> Audience Capture</Link>
          ...
          <Link href="/dashboard/install-scanner" className="inline-flex items-center gap-2 rounded-full border border-black/10 bg-white px-5 py-3 text-xs font-extrabold text-ink shadow-sm transition hover:-translate-y-0.5"><Search size={15} className="text-moss" /> Install Scanner</Link>
          ...
          <Link href="/dashboard/mvp-audit" className="inline-flex items-center gap-2 rounded-full border border-black/10 bg-white px-5 py-3 text-xs font-extrabold text-ink shadow-sm transition hover:-translate-y-0.5"><ClipboardCheck size={15} className="text-moss" /> MVP Audit</Link>
          ...
          <Link href="/dashboard/grounding" className="inline-flex items-center gap-2 rounded-full border border-black/10 bg-white px-5 py-3 text-xs font-extrabold text-ink shadow-sm transition hover:-translate-y-0.5"><BrainCircuit size={15} className="text-moss" /> Grounding</Link>
          <Link href="/dashboard/knowledge-graph" className="inline-flex items-center gap-2 rounded-full border border-black/10 bg-white px-5 py-3 text-xs font-extrabold text-ink shadow-sm transition hover:-translate-y-0.5"><Network size={15} className="text-moss" /> Knowledge Graph</Link>
