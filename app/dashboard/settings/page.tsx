...
import { buildWidgetInstallReport, buildWidgetSnippet, widgetPathForExperience, widgetPlaceholderForExperience, type WidgetEmbedExperience, type WidgetEmbedMode } from "@/lib/widget-snippet";
...
export default function SettingsPage() {
  ...
  const embedPosition = draft.launcher_position === "bottom-left" ? "left" : "right";
  const snippet = useMemo(() => buildWidgetSnippet({ origin, experience: embedType, mode: embedMode, id: embedId || embedPlaceholder, color: draft.primary_color, label: embedLabel, position: embedPosition }), [origin, embedType, embedMode, embedId, embedPlaceholder, draft.primary_color, embedLabel, embedPosition]);
  const installReport = useMemo(() => buildWidgetInstallReport({ origin, experience: embedType, mode: embedMode, id: embedId, color: draft.primary_color, label: embedLabel, position: embedPosition }), [origin, embedType, embedMode, embedId, draft.primary_color, embedLabel, embedPosition]);
