...
function assertSessionAnalytics() {
  ...
  assert(analytics.includes("launchAnalyticsProofCriteria") && analytics.includes("Proof-ready analytics means"), "Analytics dashboard should explain the acceptance criteria for production-ready analytics proof");
  ...
  assert(analyticsProof.includes("launchAnalyticsProofCriteria") && analyticsProof.includes("Proof-ready analytics means"), "Analytics proof helper should include copyable proof acceptance criteria");
...
function assertLaunchStudioWorkflow() {
  ...
  assert(settings.includes("Widget proof checklist") && settings.includes("Storefront Install Scanner") && settings.includes("widget_view, quiz_start, quiz_complete, product_recommended and buy_click"), "Settings should bridge snippet copy to storefront proof and analytics evidence");
...
function assertCatalogImportWorkflow() {
  ...
  assert(page.includes("First catalog launch kit") && page.includes("Copy catalog prep brief"), "Products dashboard should expose a visible first-catalog launch handoff");
  ...
  assert(page.includes("First catalog proof path") && page.includes("Import CSV first"), "Products dashboard empty state should guide merchants to the first real catalog proof");
  assert(page.includes("Proof-ready catalog means") && page.includes("At least 2 active products"), "Products dashboard empty state should explain production catalog acceptance criteria");
...
async function assertDeterministicLogic() {
  ...
  assert(productionVerificationReport.artifacts.some((artifact) => artifact.id === "auth-email-proof"), "Expected Production Verification artifacts to include production auth email proof");
